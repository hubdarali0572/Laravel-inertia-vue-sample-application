...
// Setup the preview (If user exists, show their current media URL)
const imagePreview = ref(props.user?.media_url ?? null); 

const handleImageChange = (e) => {
    const file = e.target.files[0];
    if (file) {
        form.image = file; // Set the file into the form object
        
        // Create the local preview
                   ...
                   <div class="p-8 md:p-10">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                                ...
                                <transition name="pop">
                                    <div v-if="isDropdownOpen" class="absolute z-50 w-full mt-24 bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
                                        ...
                                        <ul class="max-h-56 overflow-y-auto py-2">
                                            ...
                                            <li v-if="filteredRoles.length === 0" class="px-5 py-8 text-center text-slate-400 text-xs">No results found</li>
                                        </ul>
                                    </div>
                                </transition>
                            ...
                            <div class="flex flex-col">
                                ...
                                <p v-if="isEditing" class="mt-2 text-[10px] text-slate-400 font-bold italic ml-1">Leave blank to keep current password.</p>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex items-center gap-5 p-4 bg-slate-50 border border-slate-200 rounded-lg">
                                    ...
                                    <div class="relative shrink-0">
                                        <div class="w-20 h-20 rounded-xl bg-slate-200 border-2 border-white shadow-sm overflow-hidden flex items-center justify-center">
